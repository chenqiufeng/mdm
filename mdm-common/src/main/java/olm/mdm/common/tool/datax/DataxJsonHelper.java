package olm.mdm.common.tool.datax;
...
import olm.mdm.common.core.domain.dto.*;
import olm.mdm.common.core.domain.entity.DatasourceEntity;
import olm.mdm.common.tool.datax.reader.*;
import olm.mdm.common.tool.datax.writer.*;
...
import static olm.mdm.common.constant.JdbcConstants.*;
...
public class DataxJsonHelper implements DataxJsonInterface {
     ...
     * reader jdbc 数据源
     */
    private DatasourceEntity readerDatasource;
    /**
     * writer jdbc 数据源
     */
    private DatasourceEntity writerDatasource;
    /**
     * 写入的表
     */
    ...
    public void initReader(DataXJsonBuildDto dataxJsonDto, DatasourceEntity readerDatasource) {
    ...
    public void initWriter(DataXJsonBuildDto dataxJsonDto, DatasourceEntity readerDatasource) {
