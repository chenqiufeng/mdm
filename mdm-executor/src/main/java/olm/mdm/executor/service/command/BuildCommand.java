package olm.mdm.executor.service.command;
...
import olm.mdm.executor.service.jobhandler.DataXConstant;
import olm.mdm.framework.util.Constants;
...
public class BuildCommand {
    ...
    private static String buildPartition(List<String> partitionInfo) {
        ...
        String partitionTime = DateUtil.format(DateUtils.addDays(new Date(), timeOffset), timeFormat);
