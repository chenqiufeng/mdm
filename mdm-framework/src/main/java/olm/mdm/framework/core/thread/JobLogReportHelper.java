                    ...
                    try {
                        ...
                        for (int i = 0; i < 3; i++) {
                            ...
                            if (triggerCountMap!=null && triggerCountMap.size()>0) {
                                ...
                                xxlJobLogReport.setRunningCount((long) triggerDayCountRunning);
                                xxlJobLogReport.setSucCount((long) triggerDayCountSuc);
                                xxlJobLogReport.setFailCount((long) triggerDayCountFail);
                            }
