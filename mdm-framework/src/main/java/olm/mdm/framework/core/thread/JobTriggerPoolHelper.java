...
public class JobTriggerPoolHelper {
     ...
     * add trigger
     */
    public void addTrigger(final long jobId, final TriggerTypeEnum triggerType, final long failRetryCount, final String executorShardingParam, final String executorParam) {
        ...
        triggerPool_.execute(() -> {
            ...
            try {
                ...
                if (cost > 500) {       // ob-timeout threshold 500ms
                    AtomicInteger timeoutCount = jobTimeoutCountMap.putIfAbsent(Math.toIntExact(jobId), new AtomicInteger(1));
