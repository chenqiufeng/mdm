package olm.mdm.rpc.remoting.invoker.reference;

import olm.mdm.rpc.remoting.invoker.XxlRpcInvokerFactory;
import olm.mdm.rpc.remoting.invoker.call.CallType;
import olm.mdm.rpc.remoting.invoker.call.XxlRpcInvokeCallback;
import olm.mdm.rpc.remoting.invoker.call.XxlRpcInvokeFuture;
import olm.mdm.rpc.remoting.invoker.generic.XxlRpcGenericService;
...
import olm.mdm.rpc.remoting.net.params.XxlRpcFutureResponse;
import olm.mdm.rpc.remoting.net.params.XxlRpcRequest;
import olm.mdm.rpc.remoting.net.params.XxlRpcResponse;
import olm.mdm.rpc.remoting.provider.XxlRpcProviderFactory;
import olm.mdm.rpc.serialize.Serializer;
import olm.mdm.rpc.serialize.impl.HessianSerializer;
import olm.mdm.rpc.util.ClassUtil;
import olm.mdm.rpc.util.XxlRpcException;
